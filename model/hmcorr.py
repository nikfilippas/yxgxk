...
POPT_T08 = [[] for i in range(z.size)]
PCOV_T08 = [[] for i in range(z.size)]

POPT_T10 = [[] for i in range(z.size)]
PCOV_T10 = [[] for i in range(z.size)]
...
print("A_bf = %.16f" % a_bf) # 0.3609866406234923
